...
Menubar.File = function ( editor ) {
	...
	option.onClick( function () {
		...
		if ( confirm( 'Any unsaved data will be lost. Are you sure?' ) ) {
            ...
            editor.addObject( light, editor.scene);
	...
	var option = new UI.Row();
	option.setClass( 'option' );
	option.setTextContent( 'Save Geometry' );
	option.onClick( function () {
	...
	var option = new UI.Row();
	option.setClass( 'option' );
	option.setTextContent( 'Save Object' );
	option.onClick( function () {
        ...
        //object.applyMatrix( new THREE.Matrix4().makeTranslation(2, 0, 0) );
    ...
    */
    ...
    var option = new UI.Row();
    option.setClass( 'option' );
    option.setTextContent( 'Create Model (mockup)' );
    option.onClick( function(){
        
        document.getElementById("mockup1").style.display = 'block';
